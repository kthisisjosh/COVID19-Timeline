  ...
  render() {
    ...
    return (
      <Paper
        ...
        style={{ backgroundColor: '#12171d', height: '19vh' }}
      >
        <Fab
          className="dateslider-button"
          style={{ float: 'left', marginTop: '5%', marginLeft: '2%' }}
          aria-label="prev"
          size="small"
          onClick={() => {
            if (
        ...
        <Fab
          className="dateslider-button"
          style={{ float: 'left', marginTop: '5%', marginLeft: '8%' }}
          aria-label="prev"
          size="small"
          onClick={() => {
            if (
              moment(this.props.date).subtract(1, 'days').isAfter('2019-12-31')
            ) {
        ...
        <Fab
          className="dateslider-button"
          style={{ float: 'right', marginTop: '5%', marginRight: '2%' }}
          aria-label="next"
          size="small"
          onClick={() => {
        ...
        <Fab
          className="dateslider-button"
          style={{ float: 'right', marginTop: '5%', marginRight: '8%' }}
          aria-label="next"
          size="small"
          onClick={() => {
